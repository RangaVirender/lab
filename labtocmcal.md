...
<tr>
<td colspan=2><input id="btn" type=button value="Calculate" OnClick="calc.displayCMEnergy.value = (calc.displayLabEnergy.value*calc.displayAtarget.value/(calc.displayAproj.value + calc.displayAtarget.value)).toPrecision(6)"></td>
